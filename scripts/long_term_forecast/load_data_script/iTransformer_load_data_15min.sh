...
# iTransformer model for load_data dataset (15-minute granularity)
...
echo "========================================"
echo "Starting iTransformer experiments for load_data dataset (15-minute granularity)"
...
echo ""
echo "========================================"
echo "All iTransformer experiments completed for 15-minute granularity data!"
