...
# Autoformer model for load_data dataset (60-minute granularity)
...
echo "========================================"
echo "Starting Autoformer experiments for load_data dataset (60-minute granularity)"
...
echo ""
echo "========================================"
echo "All Autoformer experiments completed for 60-minute granularity data!"
