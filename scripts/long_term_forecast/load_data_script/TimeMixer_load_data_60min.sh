...
# TimeMixer model for load_data dataset (60-minute granularity)
...
echo "========================================"
echo "Starting TimeMixer experiments for load_data dataset (60-minute granularity)"
...
echo ""
echo "========================================"
echo "All TimeMixer experiments completed for 60-minute granularity data!"
