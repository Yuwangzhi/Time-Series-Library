...
# Nonstationary_Transformer model for load_data dataset (15-minute granularity)
...
echo "========================================"
echo "Starting Nonstationary_Transformer experiments for load_data dataset (15-minute granularity)"
...
echo ""
echo "========================================"
echo "All Nonstationary_Transformer experiments completed for 15-minute granularity data!"
