...
# Transformer model for load_data dataset (15-minute granularity)
...
echo "========================================"
echo "Starting Transformer experiments for load_data dataset (15-minute granularity)"
...
echo ""
echo "========================================"
echo "All Transformer experiments completed for 15-minute granularity data!"
