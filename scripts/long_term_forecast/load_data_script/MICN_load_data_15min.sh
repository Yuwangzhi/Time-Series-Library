...
# MICN model for load_data dataset (15-minute granularity)
...
echo "========================================"
echo "Starting MICN experiments for load_data dataset (15-minute granularity)"
...
echo ""
echo "========================================"
echo "All MICN experiments completed for 15-minute granularity data!"
