...
# TimesNet model for load_data dataset (60-minute granularity)
...
echo "========================================"
echo "Starting TimesNet experiments for load_data dataset (60-minute granularity)"
...
echo ""
echo "========================================"
echo "All TimesNet experiments completed for 60-minute granularity data!"
