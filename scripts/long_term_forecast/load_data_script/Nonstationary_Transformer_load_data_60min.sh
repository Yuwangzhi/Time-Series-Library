...
# Nonstationary_Transformer model for load_data dataset (60-minute granularity)
...
echo "========================================"
echo "Starting Nonstationary_Transformer experiments for load_data dataset (60-minute granularity)"
...
echo ""
echo "========================================"
echo "All Nonstationary_Transformer experiments completed for 60-minute granularity data!"
