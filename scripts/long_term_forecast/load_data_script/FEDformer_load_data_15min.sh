...
# FEDformer model for load_data dataset (15-minute granularity)
...
echo "========================================"
echo "Starting FEDformer experiments for load_data dataset (15-minute granularity)"
...
echo ""
echo "========================================"
echo "All FEDformer experiments completed for 15-minute granularity data!"
