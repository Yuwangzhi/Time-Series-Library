...
# Nonstationary_Transformer model for load_data dataset
...
echo "========================================"
echo "Starting Nonstationary_Transformer experiments for load_data dataset"
...
echo ""
echo "========================================"
echo "All Nonstationary_Transformer experiments completed!"
