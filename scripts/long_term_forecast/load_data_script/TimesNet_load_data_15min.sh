...
# TimesNet model for load_data dataset (15-minute granularity)
...
echo "========================================"
echo "Starting TimesNet experiments for load_data dataset (15-minute granularity)"
...
echo ""
echo "========================================"
echo "All TimesNet experiments completed for 15-minute granularity data!"
