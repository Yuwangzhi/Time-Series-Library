...
# Crossformer model for load_data dataset (60-minute granularity)
...
echo "========================================"
echo "Starting Crossformer experiments for load_data dataset (60-minute granularity)"
...
echo ""
echo "========================================"
echo "All Crossformer experiments completed for 60-minute granularity data!"
