...
# Autoformer model for load_data dataset (15-minute granularity)
...
echo "========================================"
echo "Starting Autoformer experiments for load_data dataset (15-minute granularity)"
...
echo ""
echo "========================================"
echo "All Autoformer experiments completed for 15-minute granularity data!"
