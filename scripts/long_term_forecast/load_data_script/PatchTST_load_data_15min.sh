...
# PatchTST model for load_data dataset (15-minute granularity)
...
echo "========================================"
echo "Starting PatchTST experiments for load_data dataset (15-minute granularity)"
...
echo ""
echo "========================================"
echo "All PatchTST experiments completed for 15-minute granularity data!"
